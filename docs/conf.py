# -*- coding: utf-8 -*-
#
# txacme documentation build configuration file, created by
...
project = u'txacme'
copyright = u'2016, Tristan Seligmann'
author = u'Tristan Seligmann'
...
from txacme import __version__, _version
version = release = __version__
txacme_version_info = _version.get_versions()
print(repr(txacme_version_info))
...
latex_documents = [
    (master_doc, 'txacme.tex', u'txacme Documentation',
     u'Tristan Seligmann', 'manual'),
]
...
man_pages = [
    (master_doc, 'txacme', u'txacme Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'txacme', u'txacme Documentation',
     author, 'txacme', 'One line description of project.',
     'Miscellaneous'),
]
